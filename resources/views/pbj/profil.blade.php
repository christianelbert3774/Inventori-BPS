...
<div class="profil-hero">
  <div class="profil-hero-left">
    ...
    <div class="profil-hero-info">
      ...
      <div class="profil-role-badge">
        <i class="bi bi-briefcase"></i> Pejabat Pengadaan
      </div>
  ...
  <div class="profil-hero-stats">
    <div class="profil-stat">
      <div class="pstat-num">{{ $totalDiproses }}</div>
      <div class="pstat-lbl">Total Diproses</div>
    </div>
    <div class="profil-stat">
      <div class="pstat-num">{{ $totalSelesai }}</div>
      <div class="pstat-lbl">Selesai</div>
    </div>
    <div class="profil-stat">
      <div class="pstat-num orange">{{ $pending }}</div>
...
<div id="tab-info" class="tab-pane active">
  <div class="form-card">
    ...
    <form method="POST" action="{{ route('pbj.profil.update') }}" id="form-profil-info">
      @csrf @method('PATCH')
      <div class="form-card-body">
        ...
        <div class="info-banner blue" style="margin-top:10px">
          ...
          <p>Role akun Anda adalah <strong>Pejabat Pengadaan</strong>. Hubungi administrator untuk mengubah role.</p>
        </div>
      </div>
...
<div id="tab-password" class="tab-pane" style="display:none">
  <div class="form-card">
    ...
    <form method="POST" action="{{ route('pbj.profil.password') }}" id="form-profil-password">
      @csrf @method('PATCH')
      <div class="form-card-body">
